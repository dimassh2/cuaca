document.addEventListener('DOMContentLoaded', () => {
    ...
    const realtimeChart1 = new Chart(document.getElementById('chart-temp-humidity'), { type: 'line', options: dualAxisOptions, data: { datasets: [ { label: 'Suhu', data: [], yAxisID: 'y', borderColor: '#e53e3e', backgroundColor: '#e53e3e33', tension: 0.3, fill: true }, { label: 'Lembap', data: [], yAxisID: 'y1', borderColor: '#4299e1', backgroundColor: '#4299e133', tension: 0.3, fill: true } ]}});
